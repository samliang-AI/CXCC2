    ...
    <div className="space-y-6">
      ...
      <Card>
        ...
        <CardContent className="grid gap-4 md:grid-cols-5">
          <div>
            <label className="text-sm font-medium mb-2 block">坐席工号/姓名</label>
            <Input
            ...
            <Table>
              ...
              <TableBody>
                {rows.length === 0 ? (
                  ...
                  rows.map((row, idx) => (
                    <TableRow key={String(row.agent || idx)}>
                      {cols.map((c) => (
                        <TableCell key={`${String(row.agent || idx)}-${c}`}>
